...
faqs:
  ...
  - question: "How do I know if it's my wheel bearings or something else?"
    answer: "Wheel bearing vibration tends to shift with steering input — if the sound or feel changes when you move the wheel slightly left or right at highway speed, that's a reliable indicator. Tire imbalance doesn't shift with steering. Bearing wear also typically produces a grinding or humming sound that increases steadily with speed, rather than peaking in a specific speed range."
  - question: "Is it safe to drive with steering vibration?"
...
Vibration that appears only under braking and is felt in the brake pedal points to brake rotor thickness variation — that's a separate issue covered under our [brake repair](/services/brake-repair) service.
