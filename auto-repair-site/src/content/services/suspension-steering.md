...
faqs:
  - question: "How do I know if my suspension needs repair or just an alignment?"
    answer: "Alignment corrects the angle of your wheels — it doesn't fix worn components. If your car pulls to one side after a recent alignment, or if the steering feels loose or clunky, there's a mechanical issue that needs to be found before the alignment can hold. Alignment is a calibration step, not a substitute for component repair."
  - question: "Can I keep driving if my car is pulling to one side or bouncing a lot?"
    answer: "Mild pulling often continues for a while without immediate failure, but worn tie rods, ball joints, or struts change how the car responds in a sudden maneuver. The problem isn't steady-state driving on familiar roads — it's what happens when you have to react fast."
  - question: "How long do shocks and struts typically last?"
