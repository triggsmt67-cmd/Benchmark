...
faqs:
  ...
  - question: "How do I know if my head gasket is blown versus something simpler?"
    answer: "A combustion leak test is the most reliable indicator. White smoke from the exhaust, coolant disappearing without any visible external leak, milky residue on the oil cap, and bubbling in the coolant reservoir are all signs of combustion gases entering the cooling system. Any of those symptoms warrant a pressure and combustion test before anything else."
  - question: "What does it cost to fix an overheating engine?"
