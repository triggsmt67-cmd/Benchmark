        ...
        <section id="contact" className="py-20 md:py-24 bg-gradient-to-r from-navy-950 to-navy-900 border-t-4 border-brand-red">
            <div className="container mx-auto px-4 md:px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Button size="lg" variant="outline" asChild className="w-full sm:w-auto border-surface text-surface hover:bg-surface hover:text-navy-950 h-14 px-10 text-lg transition-colors rounded-md">
