                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <Stagger className="max-w-2xl">
                        ...
                        <div className="space-y-6 text-text-secondary text-lg leading-relaxed mt-8">
                            <StaggerItem>
                                <p>
                                    Benchmark Automotive Service is an auto repair shop in Missoula, MT focused on accurate diagnostics, honest recommendations, and verified repairs. Backed by over 20 years of hands-on automotive experience, we service brakes, electrical issues, engine performance concerns, suspension, AC and heating, and routine maintenance. We explain what’s urgent, what can wait, and do not recommend repairs without testing. Learn more <Link href="/about" className="text-copper font-medium hover:underline">about our shop and review standards</Link>, or read our <Link href="/guides/how-to-choose-a-mechanic" className="text-copper font-medium hover:underline">guide on choosing a mechanic</Link>.
                                </p>
                            </StaggerItem>
                        </div>
                    </Stagger>
