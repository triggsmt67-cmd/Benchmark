...
export default function EastMissoulaServiceAreaPage() {
    const faqs = [
        {
            question: "Do you serve drivers from East Missoula?",
            answer: "Yes. Benchmark Automotive Service helps East Missoula drivers with diagnostics, brake repair, maintenance, inspections, electrical concerns, and general auto repair from our Missoula shop."
        },
        {
            question: "Is the drive from East Missoula to Missoula worth it for auto service?",
            answer: "Yes. While standard maintenance can be done anywhere, complex electrical diagnostics, steering vibrations, or check engine light troubleshooting are best handled by a shop specializing in testing rather than part-guessing."
        },
        {
