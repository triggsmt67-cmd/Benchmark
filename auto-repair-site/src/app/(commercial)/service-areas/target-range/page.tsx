...
export default function TargetRangeServiceAreaPage() {
    const faqs = [
        {
            question: "Do you serve drivers from Target Range?",
            answer: "Yes. Benchmark Automotive Service is located in Missoula and regularly serves drivers from Target Range, Orchard Homes, and nearby areas."
        },
        {
